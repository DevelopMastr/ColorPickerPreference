...
public class PickerSquare extends View {
	Paint paint;
	Shader luar;
	final float[] color = { 1.f, 1.f, 1.f };

	public PickerSquare(Context context, AttributeSet attrs) {
		super(context, attrs);
	}

	public PickerSquare(Context context, AttributeSet attrs, int defStyle) {
