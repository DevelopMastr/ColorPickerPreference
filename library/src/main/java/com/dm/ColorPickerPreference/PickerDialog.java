package com.dm.ColorPickerPreference;
...
import com.dm.colorPickerPreference.R;

public class PickerDialog {
	public interface OnAmbilWarnaListener {
		void onCancel(PickerDialog dialog);

		void onOk(PickerDialog dialog, int color);
	}
	 ...
	 */
	public PickerDialog(final Context context, int color, OnAmbilWarnaListener listener) {
	 ...
	 * @param listener an OnAmbilWarnaListener, allowing you to get back error or OK
	 */
	public PickerDialog(final Context context, int color, boolean supportsAlpha, OnAmbilWarnaListener listener) {
		...
		viewSatVal = (PickerSquare) view.findViewById(R.id.ambilwarna_viewSatBri);
		...
		if (supportsAlpha) viewAlphaCheckered.setOnTouchListener(new View.OnTouchListener() {
			...
			public boolean onTouch(View v, MotionEvent event) {
				...
				|| (event.getAction() == MotionEvent.ACTION_UP)) {
					...
					PickerDialog.this.setAlpha(a);

					// update view
					moveAlphaCursor();
					int col = PickerDialog.this.getColor();
		...
		.setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
			...
			public void onClick(DialogInterface dialog, int which) {
				if (PickerDialog.this.listener != null) {
					PickerDialog.this.listener.onOk(PickerDialog.this, getColor());
				}
			}
		})
		.setNegativeButton(android.R.string.cancel, new DialogInterface.OnClickListener() {
			...
			public void onClick(DialogInterface dialog, int which) {
				if (PickerDialog.this.listener != null) {
					PickerDialog.this.listener.onCancel(PickerDialog.this);
				}
			}
		})
		...
		vto.addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
			...
			public void onGlobalLayout() {
				moveCursor();
				if (PickerDialog.this.supportsAlpha) moveAlphaCursor();
				moveTarget();
				if (PickerDialog.this.supportsAlpha) updateAlphaView();
