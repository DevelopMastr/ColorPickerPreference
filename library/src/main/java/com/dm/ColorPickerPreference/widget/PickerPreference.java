package com.dm.ColorPickerPreference.widget;
...
import com.dm.ColorPickerPreference.PickerDialog;
...
public class PickerPreference extends Preference {
	...
	@Override protected void onClick() {
		new PickerDialog(getContext(), value, supportsAlpha, new PickerDialog.OnAmbilWarnaListener() {
			@Override public void onOk(PickerDialog dialog, int color) {
			...
			@Override public void onCancel(PickerDialog dialog) {
				// nothing to do
			}
		}).show();
	}
